          ...
          >
            ...
            <div className="flex flex-col items-start w-full px-[12px] py-[12px] gap-[10px] md:px-[24px] md:py-[32px] md:gap-[40px]  ">
              <div className=" flex justify-between items-center w-full ">
                ...
                {/* Approved btn */}
                <button className=" flex py-[8px] px-[12px] text-[#29B48B] justify-center items-center border border-[#29B48B] rounded-[4px] bg-[#EFF9F0] ">
                  Approved
                </button>
              </div>
              ...
              {/* view more */}
              <div
                  className="flex md:hidden items-center gap-[8px] text-[#29B48B] cursor-pointer"
                  onClick={(e) => {
                    e.stopPropagation();
