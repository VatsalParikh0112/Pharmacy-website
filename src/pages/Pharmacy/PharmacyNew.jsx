      ...
      <div className="flex flex-col items-start w-full gap-[12px]">
        {[...Array(10)].map((_, index) => (
          ...
          >
            ...
            <div className="flex flex-col items-start w-full px-[12px] py-[12px] gap-[10px] md:px-[24px] md:py-[32px] md:gap-[40px]  ">
              <div className=" flex justify-between items-center w-full ">
                ...
                <div className="font-inter hidden md:flex  gap-[18px] items-center ">
                  <button className="flex justify-center items-center rounded-[4px] bg-[#22C55E] text-white gap-[8px] p-[8px] md:gap-[8px] md:px-[16px] md:py-[12px] ">
                    <div>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                    ...
                    <div className=" text-[14px] leading-[19.6px] ">Approve</div>
                  </button>
                  <button className="flex justify-center items-center rounded-[4px] border border-[rgba(239,68,68,0.80)] bg-[rgba(239,68,68,0.10)] text-red-600 gap-[8px] p-[8px] md:gap-[8px] md:px-[16px] md:py-[12px] ">
                    <div>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                      ...
                      >
                        <path
                          d="M17 7L12 12L7 7M17 17L12 12L7 17"
                          stroke="#EF4444"
                          stroke-width="1.25"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                    ...
                    <div className=" text-[14px] leading-[19.6px] ">Reject</div>
                  </button>
                </div>
              </div>
              ...
              <div className=" hidden md:flex w-full justify-between ">
                <div className=" flex flex-col items-start ">
                  <div className=" font-inter font-normal opacity-50 text-[14px] leading-[19.2px] ">Genric Name</div>
                  <div className=" font-poppins font-medium text-[16px] leading-[25.2px] ">Amoxicillin</div>
                </div>
                <div className=" flex flex-col items-start ">
                  <div className=" font-inter font-normal opacity-50 text-[14px] leading-[19.2px] ">Brand Name</div>
                  <div className=" font-poppins font-medium text-[16px] leading-[25.2px] ">Amoxil</div>
                </div>
                <div className=" flex flex-col items-start ">
                  <div className=" font-inter font-normal opacity-50 text-[14px] leading-[19.2px] ">Strength</div>
                  <div className=" font-poppins font-medium text-[16px] leading-[25.2px] ">500mg</div>
                </div>
                <div className=" flex flex-col items-start ">
                  <div className=" font-inter font-normal opacity-50 text-[14px] leading-[19.2px] ">Dose Form</div>
                  <div className=" font-poppins font-medium text-[16px] leading-[25.2px] ">1 Tablet daily</div>
                </div>
                <div className=" flex flex-col items-start ">
                  <div className=" font-inter font-normal opacity-50 text-[14px] leading-[19.2px] ">NDC</div>
                  <div className=" font-poppins font-medium text-[16px] leading-[25.2px] ">0-123-456-789</div>
                </div>
              </div>
            </div>
            ...
            {/* Dropdown Content */}
            {openDropdown === index && (
              <div className="border-t border-gray-300 w-full px-[12px] py-[12px] rounded-b-[4px] shadow-md">
                {/* Details */}
                <div className=" flex flex-col gap-[12px] font-inter">
                  ...
                  {/* Buttons */}
                  <div className="font-inter flex md:hidden w-full gap-[18px] items-center justify-center ">
                  <button className="flex justify-center items-center rounded-[4px] bg-[#22C55E] text-white gap-[8px] p-[8px] md:gap-[8px] md:px-[16px] md:py-[12px] ">
                    <div>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
